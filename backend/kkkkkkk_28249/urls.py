"""kkkkkkk_28249 URL Configuration
...
admin.site.site_header = "kkkkkkk"
admin.site.site_title = "kkkkkkk Admin Portal"
admin.site.index_title = "kkkkkkk Admin"

# swagger
api_info = openapi.Info(
    title="kkkkkkk API",
    default_version="v1",
    description="API documentation for kkkkkkk App",
)
